...
label = "test_no_compute"  # Change this to change the name of the output directory
...
compute!(ζ_tendency)
compute!(ζ_cor)
Computation of tracked fields in this way ALSO fails if you remove the compute!
    (Eulerian picture still valid though)
compute!(ζ_visc)
compute!(ζ_err)
